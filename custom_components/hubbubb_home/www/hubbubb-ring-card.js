...
`).map((s,i)=>b`<div class="vline ${i+1===t.line?"hit":""}"><span class="vno">${i+1}</span>${s||" "}</div>`)}</pre>`}
    ...
    `}render(){var r,a,c,d;if(!this._config)return x;if(!((a=(r=this._hass)==null?void 0:r.states)==null?void 0:a[this._config.entity]))return b`
        <ha-card>
          <div class="missing">
            Entity <code>${this._config.entity}</code> not found
          </div>
        </ha-card>
      `;let e=this._effectiveState(),s=e==="offline"?this._config.offline_color:this._config[Os[e]],i=!!this._build,n=(c=this._announce)!=null?c:null,o=(d=this._messages)!=null?d:null;return b`
      <ha-card
        class="bg-${this._config.background}${this._config.honeycomb===!1?"":" comb"}${e==="offline"?" dim":""}"
        style=${this._config.honeycomb===!1?"":`--jr-comb:${yi(s)}`}
      >
        <div
