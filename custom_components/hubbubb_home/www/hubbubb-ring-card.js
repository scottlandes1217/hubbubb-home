var ms=Object.defineProperty;var vs=(l,t,e)=>t in l?ms(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var Ht=(l,t,e)=>vs(l,typeof t!="symbol"?t+"":t,e);var Lt=globalThis,Ut=Lt.ShadowRoot&&(Lt.ShadyCSS===void 0||Lt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Zt=Symbol(),Ie=new WeakMap,gt=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Zt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(Ut&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=Ie.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Ie.set(e,t))}return t}toString(){return this.cssText}},He=l=>new gt(typeof l=="string"?l:l+"",void 0,Zt),te=(l,...t)=>{let e=l.length===1?l[0]:t.reduce((s,i,n)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+l[n+1],l[0]);return new gt(e,l,Zt)},Le=(l,t)=>{if(Ut)l.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),i=Lt.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,l.appendChild(s)}},ee=Ut?l=>l:l=>l instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return He(e)})(l):l;var{is:xs,defineProperty:ys,getOwnPropertyDescriptor:ws,getOwnPropertyNames:$s,getOwnPropertySymbols:ks,getPrototypeOf:Ms}=Object,G=globalThis,Ue=G.trustedTypes,Ss=Ue?Ue.emptyScript:"",As=G.reactiveElementPolyfillSupport,bt=(l,t)=>l,se={toAttribute(l,t){switch(t){case Boolean:l=l?Ss:null;break;case Object:case Array:l=l==null?l:JSON.stringify(l)}return l},fromAttribute(l,t){let e=l;switch(t){case Boolean:e=l!==null;break;case Number:e=l===null?null:Number(l);break;case Object:case Array:try{e=JSON.parse(l)}catch{e=null}}return e}},qe=(l,t)=>!xs(l,t),Ne={attribute:!0,type:String,converter:se,reflect:!1,useDefault:!1,hasChanged:qe};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),G.litPropertyMetadata??(G.litPropertyMetadata=new WeakMap);var W=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Ne){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(t,s,e);i!==void 0&&ys(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){let{get:i,set:n}=ws(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:i,set(o){let a=i?.call(this);n?.call(this,o),this.requestUpdate(t,a,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ne}static _$Ei(){if(this.hasOwnProperty(bt("elementProperties")))return;let t=Ms(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(bt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(bt("properties"))){let e=this.properties,s=[...$s(e),...ks(e)];for(let i of s)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,i]of e)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let i=this._$Eu(e,s);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let i of s)e.unshift(ee(i))}else t!==void 0&&e.push(ee(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Le(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(i!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:se).toAttribute(e,s.type);this._$Em=t,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(t,e){let s=this.constructor,i=s._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let n=s.getPropertyOptions(i),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:se;this._$Em=i;let a=o.fromAttribute(e,n.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(t,e,s,i=!1,n){if(t!==void 0){let o=this.constructor;if(i===!1&&(n=this[t]),s??(s=o.getPropertyOptions(t)),!((s.hasChanged??qe)(n,e)||s.useDefault&&s.reflect&&n===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:n},o){s&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,o??e??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,n]of s){let{wrapped:o}=n,a=this[i];o!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,n,a)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};W.elementStyles=[],W.shadowRootOptions={mode:"open"},W[bt("elementProperties")]=new Map,W[bt("finalized")]=new Map,As?.({ReactiveElement:W}),(G.reactiveElementVersions??(G.reactiveElementVersions=[])).push("2.1.2");var vt=globalThis,De=l=>l,Nt=vt.trustedTypes,Be=Nt?Nt.createPolicy("lit-html",{createHTML:l=>l}):void 0,Ge="$lit$",X=`lit$${Math.random().toFixed(9).slice(2)}$`,Xe="?"+X,Es=`<${Xe}>`,tt=document,xt=()=>tt.createComment(""),yt=l=>l===null||typeof l!="object"&&typeof l!="function",he=Array.isArray,Ts=l=>he(l)||typeof l?.[Symbol.iterator]=="function",ie=`[ 	
\f\r]`,mt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ve=/-->/g,We=/>/g,Y=RegExp(`>|${ie}(?:([^\\s"'>=/]+)(${ie}*=${ie}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Fe=/'/g,Ke=/"/g,Je=/^(?:script|style|textarea|title)$/i,ce=l=>(t,...e)=>({_$litType$:l,strings:t,values:e}),x=ce(1),Xs=ce(2),Js=ce(3),et=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),Qe=new WeakMap,Z=tt.createTreeWalker(tt,129);function Ye(l,t){if(!he(l)||!l.hasOwnProperty("raw"))throw Error("invalid template strings array");return Be!==void 0?Be.createHTML(t):t}var Cs=(l,t)=>{let e=l.length-1,s=[],i,n=t===2?"<svg>":t===3?"<math>":"",o=mt;for(let a=0;a<e;a++){let r=l[a],c,d,p=-1,u=0;for(;u<r.length&&(o.lastIndex=u,d=o.exec(r),d!==null);)u=o.lastIndex,o===mt?d[1]==="!--"?o=Ve:d[1]!==void 0?o=We:d[2]!==void 0?(Je.test(d[2])&&(i=RegExp("</"+d[2],"g")),o=Y):d[3]!==void 0&&(o=Y):o===Y?d[0]===">"?(o=i??mt,p=-1):d[1]===void 0?p=-2:(p=o.lastIndex-d[2].length,c=d[1],o=d[3]===void 0?Y:d[3]==='"'?Ke:Fe):o===Ke||o===Fe?o=Y:o===Ve||o===We?o=mt:(o=Y,i=void 0);let _=o===Y&&l[a+1].startsWith("/>")?" ":"";n+=o===mt?r+Es:p>=0?(s.push(c),r.slice(0,p)+Ge+r.slice(p)+X+_):r+X+(p===-2?a:_)}return[Ye(l,n+(l[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},wt=class l{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let n=0,o=0,a=t.length-1,r=this.parts,[c,d]=Cs(t,e);if(this.el=l.createElement(c,s),Z.currentNode=this.el.content,e===2||e===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=Z.nextNode())!==null&&r.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let p of i.getAttributeNames())if(p.endsWith(Ge)){let u=d[o++],_=i.getAttribute(p).split(X),b=/([.?@])?(.*)/.exec(u);r.push({type:1,index:n,name:b[2],strings:_,ctor:b[1]==="."?oe:b[1]==="?"?ae:b[1]==="@"?re:lt}),i.removeAttribute(p)}else p.startsWith(X)&&(r.push({type:6,index:n}),i.removeAttribute(p));if(Je.test(i.tagName)){let p=i.textContent.split(X),u=p.length-1;if(u>0){i.textContent=Nt?Nt.emptyScript:"";for(let _=0;_<u;_++)i.append(p[_],xt()),Z.nextNode(),r.push({type:2,index:++n});i.append(p[u],xt())}}}else if(i.nodeType===8)if(i.data===Xe)r.push({type:2,index:n});else{let p=-1;for(;(p=i.data.indexOf(X,p+1))!==-1;)r.push({type:7,index:n}),p+=X.length-1}n++}}static createElement(t,e){let s=tt.createElement("template");return s.innerHTML=t,s}};function rt(l,t,e=l,s){if(t===et)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,n=yt(t)?void 0:t._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(l),i._$AT(l,e,s)),s!==void 0?(e._$Co??(e._$Co=[]))[s]=i:e._$Cl=i),i!==void 0&&(t=rt(l,i._$AS(l,t.values),i,s)),t}var ne=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??tt).importNode(e,!0);Z.currentNode=i;let n=Z.nextNode(),o=0,a=0,r=s[0];for(;r!==void 0;){if(o===r.index){let c;r.type===2?c=new $t(n,n.nextSibling,this,t):r.type===1?c=new r.ctor(n,r.name,r.strings,this,t):r.type===6&&(c=new le(n,this,t)),this._$AV.push(c),r=s[++a]}o!==r?.index&&(n=Z.nextNode(),o++)}return Z.currentNode=tt,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},$t=class l{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=rt(this,t,e),yt(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==et&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ts(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&yt(this._$AH)?this._$AA.nextSibling.data=t:this.T(tt.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=wt.createElement(Ye(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let n=new ne(i,this),o=n.u(this.options);n.p(e),this.T(o),this._$AH=n}}_$AC(t){let e=Qe.get(t.strings);return e===void 0&&Qe.set(t.strings,e=new wt(t)),e}k(t){he(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let n of t)i===e.length?e.push(s=new l(this.O(xt()),this.O(xt()),this,this.options)):s=e[i],s._$AI(n),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=De(t).nextSibling;De(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},lt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,n){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=v}_$AI(t,e=this,s,i){let n=this.strings,o=!1;if(n===void 0)t=rt(this,t,e,0),o=!yt(t)||t!==this._$AH&&t!==et,o&&(this._$AH=t);else{let a=t,r,c;for(t=n[0],r=0;r<n.length-1;r++)c=rt(this,a[s+r],e,r),c===et&&(c=this._$AH[r]),o||(o=!yt(c)||c!==this._$AH[r]),c===v?t=v:t!==v&&(t+=(c??"")+n[r+1]),this._$AH[r]=c}o&&!i&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},oe=class extends lt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}},ae=class extends lt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}},re=class extends lt{constructor(t,e,s,i,n){super(t,e,s,i,n),this.type=5}_$AI(t,e=this){if((t=rt(this,t,e,0)??v)===et)return;let s=this._$AH,i=t===v&&s!==v||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==v&&(s===v||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},le=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){rt(this,t)}};var Ps=vt.litHtmlPolyfillSupport;Ps?.(wt,$t),(vt.litHtmlVersions??(vt.litHtmlVersions=[])).push("3.3.3");var Ze=(l,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let n=e?.renderBefore??null;s._$litPart$=i=new $t(t.insertBefore(xt(),n),n,void 0,e??{})}return i._$AI(l),i};var kt=globalThis,F=class extends W{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;let t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ze(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return et}};F._$litElement$=!0,F.finalized=!0,kt.litElementHydrateSupport?.({LitElement:F});var js=kt.litElementPolyfillSupport;js?.({LitElement:F});(kt.litElementVersions??(kt.litElementVersions=[])).push("4.2.2");function ts(l,t,e){let s=Math.max(1,Math.round(t/e)),i=new Float32Array(Math.ceil(l.length/s)),n=1e-6;for(let o=0,a=0;o<l.length;o+=s,a++){let r=Math.min(l.length,o+s),c=0;for(let p=o;p<r;p++)c+=l[p]*l[p];let d=Math.sqrt(c/(r-o));i[a]=d,d>n&&(n=d)}for(let o=0;o<i.length;o++)i[o]=Math.min(1,i[o]/n);return i}function es(l,t=2){for(let e=0;e<t;e++)for(let s=0;s<l.length;s++){let i=l[s];if(!(!i.held||i.pop>=0))for(let n=s+1;n<l.length;n++){let o=l[n];if(!o.held||o.pop>=0)continue;let a=o.x-i.x,r=o.y-i.y,c=Math.hypot(a,r);c<.001&&(a=.1,r=0,c=.1);let d=i.r+o.r,p=a/c,u=r/c;if(c<d){let _=(d-c)*.5;i.x-=p*_,i.y-=u*_,o.x+=p*_,o.y+=u*_}else if(c<d*1.5){let _=(c-d)*.06;i.x+=p*_,i.y+=u*_,o.x-=p*_,o.y-=u*_}}}return l}function ss(l,t,e,s){for(let i of l){if(!i.held||i.pop>=0)continue;let n=i.x-t,o=i.y-e,a=Math.hypot(n,o);a<.001&&(n=1,o=0,a=1);let r=s+i.r;if(a<r){let c=n/a,d=o/a;i.x=t+c*r,i.y=e+d*r;let p=i.vx*c+i.vy*d;p<0&&(i.vx-=p*c,i.vy-=p*d)}}return l}function is(l,t,e,s){for(let i of l){if(!i.held||i.pop>=0||!i.anchor)continue;let n=i.x-t,o=i.y-e,a=Math.hypot(n,o);a<.001&&(n=1,o=0,a=1);let r=n/a,c=o/a,d=s+i.r;i.x=t+r*d,i.y=e+c*d;let p=i.vx*r+i.vy*c;i.vx-=p*r,i.vy-=p*c}return l}function ns(l,t,e){let s=Math.PI*2;if(!l.length)return{angle:0,gap:s};let i=l.map(a=>Math.atan2(a.y-e,a.x-t)).sort((a,r)=>a-r),n=-1,o=0;for(let a=0;a<i.length;a++){let r=i[a],d=(a+1<i.length?i[a+1]:i[0]+s)-r;d>n&&(n=d,o=r+d/2)}return{angle:o,gap:n}}var zs="4.11.1",Dt="assist_satellite",Rs=["idle","listening","processing","responding"],de={size:240,background:"dark",particles:0,particle_size:1,follow_media_player:!0,audio_offset:0,idle_color:"#2e9df5",listening_color:"#00ff88",processing_color:"#ffaa33",responding_color:"#00e5ff",offline_color:"#4a5560",build_entity:"",build_dashboard:"",build_page:!1,build_return:"/",build_projects:[],animation:"hubbubb",assistant_name:"Assistant",panel_height:0,panel_fullscreen:!1,panel_bg:"",panel_border:"",panel_text:"",terminal_bg:"",terminal_text:"",honeycomb:!0,tap_message:"Yes?",announce_entity:"",messages_entity:""},os=(l,t)=>{let e=Math.round(t*ds);return e<0||e>=l.length?0:l[e]},Mt=16,ds=50,as={idle:"idle_color",listening:"listening_color",processing:"processing_color",responding:"responding_color"},rs={idle:{swirl:.95,bright:1.75,radius:0,amp:1,turb:.4,sweep:0,speech:0},listening:{swirl:1.8,bright:1.8,radius:-.012,amp:1.15,turb:.6,sweep:.35,speech:0},processing:{swirl:.95,bright:1.5,radius:0,amp:1,turb:.3,sweep:1,speech:0},responding:{swirl:1.5,bright:1.55,radius:.006,amp:1.15,turb:1,sweep:.12,speech:1},offline:{swirl:.3,bright:.4,radius:-.012,amp:.5,turb:.15,sweep:0,speech:0}},Os=new Set(["tool","out","err","screen","cmd"]),Is=l=>/^\$ /.test(l)?"l-cmd":/^\+/.test(l)?"l-add":/^- /.test(l)||/^--- /.test(l)?"l-del":/\b(error|errno|failed|failure|fatal|traceback|exception|refused|denied|not found|no such)\b/i.test(l)?"l-err":/\b(warn|warning|deprecat\w+|skipped)\b/i.test(l)?"l-warn":/^(Edit|Write|Read|Grep|Glob|Agent|Task|WebFetch|WebSearch|TodoWrite|Skill)\b/.test(l)?"l-tool":"",Hs=/`([^`\n]+)`|\*\*([^*\n]+)\*\*/g,pe=(l,t,e)=>l.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0})),Ls={1:"can't reach Home Assistant",2:"invalid authentication",3:"connection lost \u2014 reconnecting",4:"no Home Assistant host",5:"https/http mismatch"};var _i=Math.PI/180,st=(l,t,e)=>Math.min(e,Math.max(t,l)),ue=l=>Math.round(l*100)/100,_e=l=>{let t=l>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}},Us=l=>{let t=(1+Math.sqrt(5))/2,e=[[-1,t,0],[1,t,0],[-1,-t,0],[1,-t,0],[0,-1,t],[0,1,t],[0,-1,-t],[0,1,-t],[t,0,-1],[t,0,1],[-t,0,-1],[-t,0,1]].map(([r,c,d])=>{let p=Math.hypot(r,c,d);return[r/p,c/p,d/p]}),s=[[0,11,5],[0,5,1],[0,1,7],[0,7,10],[0,10,11],[1,5,9],[5,11,4],[11,10,2],[10,7,6],[7,1,8],[3,9,4],[3,4,2],[3,2,6],[3,6,8],[3,8,9],[4,9,5],[2,4,11],[6,2,10],[8,6,7],[9,8,1]],i=new Map,n=(r,c)=>{let d=r<c?`${r}_${c}`:`${c}_${r}`,p=i.get(d);if(p!==void 0)return p;let[u,_,b]=e[r],[m,k,L]=e[c],M=(u+m)/2,y=(_+k)/2,I=(b+L)/2,A=Math.hypot(M,y,I);return e.push([M/A,y/A,I/A]),i.set(d,e.length-1),e.length-1};for(let r=0;r<l;r++){let c=[];for(let[d,p,u]of s){let _=n(d,p),b=n(p,u),m=n(u,d);c.push([d,_,m],[p,b,_],[u,m,b],[_,b,m])}s=c}let o=new Set,a=[];for(let r of s)for(let c=0;c<3;c++){let d=r[c],p=r[(c+1)%3],u=d<p?d*1e5+p:p*1e5+d;o.has(u)||(o.add(u),a.push(d,p))}return{verts:e,edges:a}},fe=Us(3),Ns=(()=>{let l=_e(11073),t=fe.verts.length,e=[];for(let s=0;s<16;s++)e.push({v:Math.floor(l()*t),tw:.5+l()*1.6,ph:l()*6.28});return e})(),ht=96,ls=.55,hs=.45,qt=[{r:.625,amp:.068,thick:.007,rev:-.8,share:.21,glow:.72},{r:.655,amp:.075,thick:.008,rev:-.8,share:.21,glow:.85},{r:.845,amp:.082,thick:.009,rev:1,share:.3,glow:1.2},{r:.875,amp:.09,thick:.008,rev:1,share:.28,glow:1.4}],ct=128,qs=(()=>{let l=_e(51729),t=[];for(let e=0;e<5;e++)t.push({a:l()*Math.PI*2,w:(.08+l()*.22)*(e%2?-1:1),sg:.2+l()*.3,h:.6+l()*.7,f:.25+l()*.6,ph:l()*Math.PI*2});return t})(),ps=(()=>{let t=Math.sqrt(3)*5,e=(s,i)=>{let n="";for(let o=0;o<6;o++){let a=o*60*Math.PI/180;n+=`${o===0?"M":"L"}${ue(s+5*Math.cos(a))} ${ue(i+5*Math.sin(a))}`}return n+"Z"};return[e(0,0),e(3*5,0),e(0,t),e(3*5,t),e(1.5*5,t/2)].join("")})(),dt={w:15,h:ue(Math.sqrt(3)*5)},Ds=l=>'url("data:image/svg+xml,'+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="${dt.w}" height="${dt.h}" viewBox="0 0 ${dt.w} ${dt.h}"><path d="${ps}" fill="none" stroke="${l}" stroke-width="0.35"/></svg>`)+'")',cs=l=>{let t=/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i.exec(String(l).trim());if(t){let s=t[1];s.length===3&&(s=s.split("").map(n=>n+n).join(""));let i=parseInt(s,16);return[i>>16&255,i>>8&255,i&255]}let e=/rgba?\(([^)]+)\)/i.exec(String(l));if(e){let s=e[1].split(",").map(i=>parseFloat(i));return[s[0]|0,s[1]|0,s[2]|0]}return[53,224,255]},St=class extends F{set hass(t){if(this._hass=t,!this._config)return;let e=t?.states?.[this._config.entity],s=e?e.state:"unavailable",i=this._state;if(s!==this._state&&(this._state=s),this._config.build_entity){let p=t?.states?.[this._config.build_entity]?.state==="on";this._config.build_page?(this._entityOn&&!p&&this._navigate(this._config.build_return),this._entityOn=p):p!==this._build&&this._setBuild(p,!1)}let n=t?.states?.[this._config.announce_entity],o=n?n.state==="on":null;o!==this._announce&&(this._announce=o);let a=t?.states?.[this._config.messages_entity],r=a?a.state==="on":null;r!==this._messages&&(this._messages=r);let c=this._config.follow_media_player?this._resolveMediaPlayer(t):null,d=c?t?.states?.[c]?.state:void 0;d!==this._mp&&(this._mp=d),this._audioSync(c?t?.states?.[c]:null),this._state==="responding"&&i!=="responding"&&this._grabTtsUrl(),this._sessTimer||(this._sessTimer=setInterval(()=>this._pollSessions(),12e3),this._pollSessions())}_trackDone(t){this._unread||(this._unread=new Set(this._recall("unread",24*3600*1e3)||[]),this._wasBusy=new Map);let e=new Set;for(let s of t){e.add(s.id);let i=this._build&&this._sel===s.id;s.busy||i?this._unread.delete(s.id):this._wasBusy.get(s.id)&&this._unread.add(s.id),this._wasBusy.set(s.id,!!s.busy),s.done=this._unread.has(s.id)}for(let s of[...this._unread])e.has(s)||this._unread.delete(s);for(let s of[...this._wasBusy.keys()])e.has(s)||this._wasBusy.delete(s);return this._store("unread",[...this._unread]),t}async _pollSessions(){if(!(this._build||this._onScreen===!1||!this._hass))try{let t=await this._api("agent_status");this._sessions=this._trackDone(t.sessions||[]),t.projects&&(this._projects=t.projects)}catch{}}_resolveMediaPlayer(t){if(this._config.media_player)return this._config.media_player;if(this._mpResolved!==void 0)return this._mpResolved;let e=null,s=t?.entities?.[this._config.entity]?.device_id;if(s&&t.entities){for(let i in t.entities)if(i.startsWith("media_player.")&&t.entities[i].device_id===s){e=i;break}}if(!e){let n=`media_player.${this._config.entity.split(".")[1].replace(/_assist_satellite$/,"")}_media_player`;t?.states?.[n]&&(e=n)}return this._mpResolved=e,e}_effectiveState(){if(this._voiceState)return this._voiceState==="responding"&&this._envEl&&!this._envEl.currentTime?"processing":this._voiceState;let t=Rs.includes(this._state)?this._state:"offline",e=this._speechRaw(t);return this._speaking(e)?"responding":e||t==="responding"?"processing":t}_speechRaw(t){let e=this._mp;return e==="playing"?t!=="listening":e==="idle"||e==="paused"?!1:t==="responding"}_speaking(t){let e=Math.max(0,-(Number(this._config.audio_offset)||0));if(!e)return t;let s=performance.now()/1e3;return t!==this._spkRaw&&(this._spkRaw=t,this._spkAt=s),s-(this._spkAt??-1e9)<e?!t:t}get hass(){return this._hass}get _name(){return this._config?.assistant_name||"Assistant"}setConfig(t){if(!t||!t.entity)throw new Error("hubbubb-ring-card: you need to define an `entity`");if(t.entity.split(".")[0]!==Dt)throw new Error(`hubbubb-ring-card: entity must be in the ${Dt} domain`);this._config={...de,...t},this._particles=null,this._mpResolved=void 0,t.build_page&&this._setBuild(!0,!1),this._hass&&(this.hass=this._hass)}getCardSize(){return Math.max(2,Math.ceil(Number(this._config?.size??240)/50))}getGridOptions(){return{rows:Math.max(2,Math.ceil(Number(this._config?.size??240)/56)),columns:12,min_rows:2,min_columns:6}}_cardVars(t){let e=this._config,s=n=>Number(n)>0?`${Number(n)}px`:"",i={"--jr-size":`${Number(e.size)}px`,"--jr-color":t,"--jr-panel-h":e.panel_height==="fill"?"100%":s(e.panel_height),"--jr-panel-bg":e.panel_bg,"--jr-panel-border":e.panel_border,"--jr-panel-text":e.panel_text,"--jr-term-bg":e.terminal_bg,"--jr-term-text":e.terminal_text};return Object.entries(i).filter(([,n])=>n).map(([n,o])=>`${n}:${o}`).join(";")}static getConfigElement(){return document.createElement("hubbubb-ring-card-editor")}static getStubConfig(t){let e=Object.keys(t?.states??{}),s=a=>e.find(r=>r.startsWith("switch.")&&r.endsWith(a))??"",i=s("_build_mode"),o=i.slice(7,-11).split("_").filter(Boolean).map(a=>a[0].toUpperCase()+a.slice(1)).join(" ");return{type:"custom:hubbubb-ring-card",entity:e.find(a=>a.split(".")[0]===Dt)??"",...o&&{assistant_name:o},...i&&{build_entity:i},...s("_agent_announcements")&&{announce_entity:s("_agent_announcements")},...s("_message_watch")&&{messages_entity:s("_message_watch")}}}connectedCallback(){super.connectedCallback(),this._onVisibility=()=>this._pump(),document.addEventListener?.("visibilitychange",this._onVisibility),this._onHide=()=>{this._saveDraft(),this._saveQueue()},window.addEventListener?.("pagehide",this._onHide),this._restoreQueue(),this._build&&this._setBuild(!0,!1)}disconnectedCallback(){super.disconnectedCallback(),this._saveDraft(),this._saveQueue(),this._lockScroll(!1),document.removeEventListener?.("visibilitychange",this._onVisibility),window.removeEventListener?.("pagehide",this._onHide),this._stop(),this._stopPolling(),this._stopLocalVoice(),clearInterval(this._sessTimer),this._sessTimer=null,this._io?.disconnect(),this._ro?.disconnect(),this._io=this._ro=null,this._canvas=null,this._ctx=null}_navigate(t){!t||location.pathname.startsWith(t.split("?")[0])||(history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")))}_toggleAnnounce(){this._toggleHelper(this._config.announce_entity,"_announce",`${this._name} finishes: spoken on the puck`,`${this._name} finishes: phone only`)}_toggleMessages(){this._toggleHelper(this._config.messages_entity,"_messages","Hubbubb messages: read out as they arrive","Hubbubb messages: quiet")}_toggleHelper(t,e,s,i){let n=this[e]===!0;this[e]=!n,this._hass.callService("homeassistant",n?"turn_off":"turn_on",{entity_id:t}),this._toast(n?i:s)}_setBuild(t,e=!0){if(e&&this._config.build_entity&&this._hass&&this._hass.callService("homeassistant",t?"turn_on":"turn_off",{entity_id:this._config.build_entity}),this._config.build_dashboard){let s=this._build;this._build=t,t&&(e||s===!1)&&this._navigate(this._config.build_dashboard);return}if(this._config.build_page&&!t){this._navigate(this._config.build_return);return}this._build=t,t?(this._err="",this._poll(),this._startPolling(),!this._vvHandler&&window.visualViewport&&(this._vvHandler=()=>this._vvSync(),window.visualViewport.addEventListener("resize",this._vvHandler),window.visualViewport.addEventListener("scroll",this._vvHandler)),this._vvSync(),this._lockScroll(!0)):(this._stopPolling(),this._lockScroll(!1),this._sel=null,this._msgs=null,this._ask=null,this._activity=null,this._confirmKill=null,this._picking=!1,this._details=!1,this._swipe=null,this._vvHandler&&window.visualViewport&&(window.visualViewport.removeEventListener("resize",this._vvHandler),window.visualViewport.removeEventListener("scroll",this._vvHandler),this._vvHandler=null))}_lockScroll(t){if(!this._config?.build_page)return;let e=document.documentElement,s=document.body;s&&(t?(this._prevOverflow===void 0&&(this._prevOverflow=s.style.overflow,this._prevOverscroll=e.style.overscrollBehavior,this._prevHtmlOverflow=e.style.overflow),s.style.overflow="hidden",e.style.overflow="hidden",e.style.overscrollBehavior="none"):this._prevOverflow!==void 0&&(s.style.overflow=this._prevOverflow,e.style.overflow=this._prevHtmlOverflow,e.style.overscrollBehavior=this._prevOverscroll,this._prevOverflow=this._prevOverscroll=void 0,this._prevHtmlOverflow=void 0))}_syncCorner(t){window.innerWidth!==this._vvW&&(this._vvW=window.innerWidth,this._vvMax=t),this._vvMax=Math.max(this._vvMax||0,t);let e=t>=this._vvMax-4;this.style.setProperty("--jr-botr",e?"56px":"16px")}_vvSync(){let t=window.visualViewport;if(!t)return;let e=Math.round(t.height),s=Math.round(t.offsetTop),i=e!==this._vvH;i&&(this._vvH=e,this.style.setProperty("--jr-vvh",`${e}px`),this._syncCorner(e)),(i||this._vvT==null)&&(this._vvT=s,this.style.setProperty("--jr-vvt",`${s}px`),i&&this._settlePin());let n=this._vvPrev==null?0:Math.abs(e-this._vvPrev),o=this._vvPrev==null;if(this._vvPrev=e,!o&&n<12)return;let a=this._growCap();a!==this._lastCap&&(this._lastCap=a,this._autoGrow(this._composerEl())),this._stick&&requestAnimationFrame(()=>{let r=this.renderRoot?.querySelector(".log");r&&(r.scrollTop=r.scrollHeight)})}_settlePin(){clearTimeout(this._settleA),clearTimeout(this._settleB);let t=()=>{this._unscroll();let e=window.visualViewport;if(!e)return;let s=Math.round(e.offsetTop);s!==this._vvT&&(this._vvT=s,this.style.setProperty("--jr-vvt",`${s}px`))};requestAnimationFrame(t),this._settleA=setTimeout(t,200),this._settleB=setTimeout(t,500)}_unscroll(){if(!this._build)return;window.scrollTo(0,0),document.scrollingElement&&(document.scrollingElement.scrollTop=0);let t=this.parentNode;for(;t;)t.scrollTop>0&&(t.scrollTop=0),t=t.parentNode||t.host}_startPolling(){let t=this._sel?1200:2500;this._pollTimer&&this._pollMs===t||(this._pollTimer&&clearInterval(this._pollTimer),this._pollMs=t,this._pollTimer=setInterval(()=>this._poll(),t))}_stopPolling(){this._pollTimer&&clearInterval(this._pollTimer),this._pollTimer=null,this._pollMs=null}_errText(t){return typeof t=="number"?Ls[t]||`websocket error ${t}`:String(t?.message||t)}async _api(t,e={}){let s=await this._hass.callWS({type:"call_service",domain:"hubbubb_home",service:t,service_data:e,return_response:!0}),i=s?.response?.content;if(typeof i=="string")try{i=JSON.parse(i)}catch{}let n=s?.response?.status??0;if(n<200||n>=300||i?.ok===!1)throw new Error(i?.detail||i?.error||`HTTP ${n}`);return i||{}}async _poll(){if(!(!this._build||!this._hass)){if(this._polling){this._pollAgain=!0;return}this._polling=!0;try{let t=await this._api("agent_status");if(this._sessions=this._trackDone(t.sessions||[]),this._projects=t.projects||[],this._sel&&!this._sessions.some(e=>e.id===this._sel))this._sel=null,this._msgs=null,this._store("sel",null);else if(!this._sel&&!this._restored){this._restored=!0;let e=this._recall("sel",12*3600*1e3);e&&this._sessions.some(s=>s.id===e)&&this._select(e)}if(this._sel){let e=await this._api("agent_transcript",{id:this._sel,have:this._msgs==null?0:this._tbytes||0});this._tbytes=e.bytes||0;let s=e.messages;s!=null&&!this._sameMsgs(s,this._msgs)&&(this._msgs=s),this._activity=e.activity||null;let i=e.ask?JSON.stringify(e.ask.options.map(n=>n.label)):null;if(i!==this._askSig&&(this._askSig=i,this._askSent=null),this._ask=e.ask||null,this._queue?.length){let n=new Set((this._msgs||[]).filter(a=>a.role==="user").map(a=>this._collapse(a.text))),o=this._queue.length;this._queue=this._queue.filter(a=>a.state!=="sent"||!n.has(this._collapse(a.text))&&Date.now()-a.at<6e5),this._queue.length!==o&&this._saveQueue()}}this._err=""}catch(t){this._err=this._errText(t)}if(this._polling=!1,this._pollAgain)return this._pollAgain=!1,this._poll();this._drainQueue()}}_drainQueue(){if(!this._sel||this._pending)return;let t=(this._queue||[]).filter(s=>s.id===this._sel);if(t.some(s=>s.state==="sent"))return;let e=t.find(s=>s.state==="held");e&&((this._sessions||[]).find(s=>s.id===this._sel)?.busy||this._dispatch(e))}_select(t){if(this._sel&&this._sel!==t&&this._saveDraft(),this._sel=t,this._restored=!0,t&&this._unread?.delete(t)){this._store("unread",[...this._unread]);let e=(this._sessions||[]).find(s=>s.id===t);e&&(e.done=!1)}this._store("sel",t||null),this._msgs=null,this._ask=null,this._askSent=null,this._askSig=void 0,this._activity=null,this._startPolling(),this._confirmKill=null,this._details=!1,this._swipe=null,this._stick=!0,this._poll(),t&&this._api("agent_target_window",{id:t}).catch(()=>{})}_store(t,e){try{let s=`jrc:${t}`;e==null?localStorage.removeItem(s):localStorage.setItem(s,JSON.stringify({v:e,at:Date.now()}))}catch{}}_recall(t,e){try{let s=localStorage.getItem(`jrc:${t}`);if(!s)return null;let{v:i,at:n}=JSON.parse(s);return!n||Date.now()-n>e?(localStorage.removeItem(`jrc:${t}`),null):i}catch{return null}}_body(t){if(Os.has(t.role))return t.text.split(`
`).map(i=>x`<div class="${Is(i)}">${i||" "}</div>`);if(t.role!=="assistant")return t.text;let e=[],s=0;for(let i of t.text.matchAll(Hs))i.index>s&&e.push(t.text.slice(s,i.index)),e.push(i[1]?x`<code>${i[1]}</code>`:x`<b>${i[2]}</b>`),s=i.index+i[0].length;return e.push(t.text.slice(s)),e}_sameMsgs(t,e){if(!t||!e||t.length!==e.length)return!1;let s=t[t.length-1],i=e[e.length-1];return s?.role===i?.role&&s?.text===i?.text}_collapse(t){return t.split(/\s+/).join(" ")}_composerEl(){return this.renderRoot?.querySelector(".composer textarea")}_growCap(){let t=this._vvH||window.visualViewport?.height||window.innerHeight;return Math.max(56,Math.min(190,Math.round(t*.32)))}_autoGrow(t){if(!t)return;let e=t.style.height,s=t.scrollTop;t.style.height="auto";let i=Math.min(t.scrollHeight,this._growCap())+"px";return t.style.height=i,t.scrollTop!==s&&(t.scrollTop=s),i!==e}_saveDraft(t=this._sel){if(!t)return;let e=this._composerEl();e&&this._store(`draft:${t}`,e.value||null),this._store(`files:${t}`,this._files?.length?this._files:null)}_restoreDraft(){if(!this._sel)return;this._files=this._recall(`files:${this._sel}`,12*3600*1e3)||[];let t=this._composerEl();if(!t||t.value)return;let e=this._recall(`draft:${this._sel}`,12*3600*1e3);e&&(t.value=e,this._autoGrow(t))}_saveQueue(){let t=(this._queue||[]).filter(e=>e.state==="held");this._store("queue",t.length?t:null)}_restoreQueue(){let t=this._recall("queue",216e5);Array.isArray(t)&&t.length&&(this._queue=t.map(e=>({...e,state:"held"})))}async _send(t){t.preventDefault();let e=this._composerEl(),s=e?.value.trim(),i=this._files||[];if(!s&&!i.length||this._sel==null)return;let n=[...i.map(a=>a.path),s].filter(Boolean).join(" ");e.value="",e.style.height="",this._files=[],this._saveDraft();let o={id:this._sel,text:n,at:Date.now(),state:"held"};this._queue=[...this._queue||[],o],this._saveQueue(),this._stick=!0,(this._sessions||[]).find(a=>a.id===this._sel)?.busy||this._dispatch(o)}async _dispatch(t){if(!this._pending){this._pending=!0,t.state="sent",this._queue=[...this._queue],this._saveQueue();try{await this._api("agent_prompt_direct",{id:t.id,text:t.text}),this._err=""}catch(e){this._err=this._errText(e),t.state="held",this._queue=[...this._queue],this._saveQueue()}this._pending=!1,this._poll()}}_editQueued(t){let e=this._composerEl();e&&(e.value=e.value.trim()?`${e.value.trim()} ${t.text}`:t.text,this._dropQueued(t),e.focus(),this._autoGrow(e),this._saveDraft())}_dropQueued(t){this._queue=(this._queue||[]).filter(e=>e!==t),this._saveQueue()}async _attach(t){let e=[...t.target.files||[]];return t.target.value="",this._ingest(e)}async _ingest(t){if(!(!t.length||!this._sel)){this._uploading=!0;for(let e of t)try{let{name:s,data:i}=await this._encodeFile(e),n=await this._api("agent_upload",{name:s,data:i});if(!n?.path)throw new Error(n?.detail||"upload refused");this._files=[...this._files||[],{name:e.name,path:n.path}],this._err=""}catch(s){this._err=`${e.name}: ${this._errText(s)}`}this._uploading=!1,this._saveDraft()}}_encodeFile(t){let e=i=>new Promise((n,o)=>{let a=new FileReader;a.onerror=()=>o(new Error("could not read that file")),a.onload=()=>n(String(a.result).split(",")[1]||""),a.readAsDataURL(i)});if(!t.type.startsWith("image/"))return e(t).then(i=>({name:t.name,data:i}));let s=1568;return new Promise((i,n)=>{let o=new Image,a=URL.createObjectURL(t);o.onerror=()=>{URL.revokeObjectURL(a),e(t).then(r=>i({name:t.name,data:r}),n)},o.onload=()=>{URL.revokeObjectURL(a);let r=Math.min(1,s/Math.max(o.width,o.height));if(r===1&&t.size<9e5)return e(t).then(d=>i({name:t.name,data:d}),n);let c=document.createElement("canvas");c.width=Math.round(o.width*r),c.height=Math.round(o.height*r),c.getContext("2d").drawImage(o,0,0,c.width,c.height),c.toBlob(d=>{if(!d)return n(new Error("could not encode that image"));let p=t.name.replace(/\.[^.]+$/,"")+".jpg";e(d).then(u=>i({name:p,data:u}),n)},"image/jpeg",.85)},o.src=a})}_dropFile(t){this._files=(this._files||[]).filter(e=>e!==t),this._saveDraft()}async _sendKey(t){if(this._sel){this._askSent=t;try{await this._api("agent_key",{id:this._sel,key:t}),this._err=""}catch(e){this._err=this._errText(e),this._askSent=null;return}this._poll()}}async _killSession(t){if(t){if(this._confirmKill!==t){this._confirmKill=t,clearTimeout(this._confirmT),this._confirmT=setTimeout(()=>this._confirmKill=null,4e3);return}clearTimeout(this._confirmT),this._confirmKill=null;try{await this._api("agent_kill",{id:t}),this._swipe=null,this._store(`draft:${t}`,null),this._queue=(this._queue||[]).filter(e=>e.id!==t),this._saveQueue(),this._sel===t&&(this._sel=null,this._msgs=null,this._store("sel",null)),this._poll()}catch(e){this._err=this._errText(e)}}}_rowTap(t){if(this._swipe===t){this._swipe=null,this._confirmKill=null;return}if(this._swipe){this._swipe=null,this._confirmKill=null;return}this._swiped||this._select(t)}_swipeStart(t,e){let s=t.touches?.[0];s&&(this._sx=s.clientX,this._sy=s.clientY,this._swiped=!1)}_swipeMove(t,e){let s=t.touches?.[0];if(!s||this._sx==null)return;let i=s.clientX-this._sx,n=s.clientY-this._sy;Math.abs(n)>Math.abs(i)||(i<-12?(this._swiped=!0,this._swipe!==e&&(this._swipe=e)):i>12&&this._swipe===e&&(this._swiped=!0,this._swipe=null,this._confirmKill=null))}_swipeEnd(){this._sx=this._sy=null,setTimeout(()=>this._swiped=!1,50)}async _newSession(t){this._picking=!1,this._pending=!0;try{await this._api("agent_start_session",{project:t}),this._err="";for(let e=0;e<20;e++){await this._poll();let s=(this._sessions||[]).find(i=>i.target);if(s){this._select(s.id);break}await new Promise(i=>setTimeout(i,600))}}catch(e){this._err=this._errText(e)}this._pending=!1}_openAssist(){let t=this._hass?.auth?.external;if(t?.config?.hasAssist){t.fireMessage({type:"assist/show"});return}pe(this,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>customElements.whenDefined("ha-voice-command-dialog"),dialogParams:{pipeline_id:"last_used",start_listening:!0}})}_wakePuck(){let t;try{t=this._hass?.callService("assist_satellite","start_conversation",{entity_id:this._config.entity,start_message:this._config.tap_message,preannounce:!1},void 0,!1)}catch{return this._openAssist()}Promise.resolve(t).catch(()=>this._openAssist())}async _startLocalVoice(t="converse"){if(this._voice)return!0;let e;try{e=await navigator.mediaDevices.getUserMedia({audio:!0})}catch{return"microphone permission denied"}let s=window.AudioContext||window.webkitAudioContext,i;try{i=new s({sampleRate:16e3})}catch{i=new s}let n=null;t==="converse"&&(n=new Audio("data:audio/wav;base64,UklGRiQAAABXQVZFZm10IBAAAAABAAEAQB8AAIA+AAACABAAZGF0YQAAAAA="),n.play().catch(()=>{}));let o=this._voice={mode:t,stream:e,ctx:i,audio:n,proc:null,src:null,handlerId:null,unsub:null};t==="converse"?this._voiceState="listening":this._dictating=!0;let a=this._recall("conv",5*60*1e3);try{o.unsub=await this._hass.connection.subscribeMessage(d=>this._voiceEvent(d),{type:"assist_pipeline/run",start_stage:"stt",end_stage:t==="dictate"?"stt":"tts",input:{sample_rate:i.sampleRate},...a?{conversation_id:a}:{}})}catch{return this._stopLocalVoice(),"assist pipeline refused the run"}let r=o.src=i.createMediaStreamSource(e),c=o.proc=i.createScriptProcessor(2048,1,1);return c.onaudioprocess=d=>{if(o.handlerId==null)return;let p=d.inputBuffer.getChannelData(0),u=new Uint8Array(1+p.length*2);u[0]=o.handlerId;let _=new DataView(u.buffer,1);for(let b=0;b<p.length;b++){let m=Math.max(-1,Math.min(1,p[b]));_.setInt16(b*2,m<0?m*32768:m*32767,!0)}try{this._hass.connection.socket.send(u)}catch{}},r.connect(c),c.connect(i.destination),!0}_voiceEvent(t){let e=this._voice;if(e)switch(t.type){case"run-start":e.handlerId=t.data?.runner_data?.stt_binary_handler_id??null;break;case"intent-end":{let s=t.data?.intent_output?.conversation_id;s&&this._store("conv",s);break}case"stt-end":if(e.mode==="dictate"){let s=t.data?.stt_output?.text||"",i=this.renderRoot?.querySelector(".composer textarea");i&&s&&(i.value=(i.value?i.value.trim()+" ":"")+s,i.focus()),s||this._toast("Didn't catch that."),this._stopLocalVoice()}else this._closeMic(),this._voiceState="processing";break;case"tts-end":{let s=t.data?.tts_output?.url;if(!s)return this._stopLocalVoice();this._voiceState="responding",e.audio.onended=()=>this._stopLocalVoice(),e.audio.onerror=()=>this._stopLocalVoice(),this._envEl=e.audio,this._envUrl=s,this._env=null,this._decodeAudio(s),e.audio.src=s,e.audio.play().catch(()=>this._stopLocalVoice());break}case"error":e.mode==="dictate"&&this._toast("Didn't catch that."),this._stopLocalVoice();break;case"run-end":this._voiceState!=="responding"&&this._stopLocalVoice();break}}_closeMic(){let t=this._voice;t&&(t.proc?.disconnect(),t.src?.disconnect(),t.stream?.getTracks().forEach(e=>e.stop()),t.ctx?.close().catch(()=>{}),t.proc=t.src=null)}_stopLocalVoice(){let t=this._voice;if(t){this._closeMic(),this._dictating=!1;try{t.audio?.pause()}catch{}try{t.unsub?.()}catch{}this._voice=null,this._voiceState=null,this._envEl=null,this._env=null,this._envUrl=null}}_toast(t){pe(this,"hass-notification",{message:t})}get _canMic(){return!!(window.isSecureContext&&navigator.mediaDevices?.getUserMedia)}async _composerMic(){if(this._voice)return this._voice.mode==="dictate"?this._endSpeech():this._stopLocalVoice();if(!window.isSecureContext||!navigator.mediaDevices?.getUserMedia){this._toast("Voice input needs the https (Nabu Casa) URL.");return}let t=await this._startLocalVoice("dictate");t!==!0&&this._toast(`Couldn't start voice input (${t}).`)}_endSpeech(){let t=this._voice;if(!t||t.handlerId==null)return this._stopLocalVoice();t.proc?.disconnect(),t.src?.disconnect(),t.mode==="converse"&&(this._voiceState="processing");try{this._hass.connection.socket.send(new Uint8Array([t.handlerId]))}catch{this._stopLocalVoice()}}async _ringTap(){if(this._voice)return this._voiceState==="listening"?this._endSpeech():this._stopLocalVoice();if(this._effectiveState()==="responding"){let e=this._resolveMediaPlayer(this._hass);if(e){this._hass.callService("media_player","media_stop",{entity_id:e});return}}if(!window.isSecureContext){this._wakePuck();return}if(!navigator.mediaDevices?.getUserMedia){this._toast(`This browser exposes no microphone \u2014 waking ${this._name} instead.`),this._wakePuck();return}let t=await this._startLocalVoice();t!==!0&&(this._toast(`Couldn't use this device's mic (${t}) \u2014 waking ${this._name} instead.`),this._wakePuck())}firstUpdated(){this._setupCanvas()}updated(t){if(this._setupCanvas(),t.has("_sel")&&this._sel&&this._restoreDraft(),t.has("_msgs")&&this._stick){let e=this.renderRoot.querySelector(".log");e&&(e.scrollTop=e.scrollHeight)}}_setupCanvas(){let t=this.renderRoot?.querySelector("canvas");if(!t){this._stop(),this._canvas=null;return}if(t!==this._canvas){this._canvas=t;try{this._ctx=t.getContext("2d")}catch{this._ctx=null}if(!this._ctx)return;this._t=0,this._waveT=0,this._churnT=0,this._peaks=qs.map(e=>({...e})),this._spin=0,this._head=0,this._speech={t:0,next:0,env:0,count:0,syl:null,pulses:[],spikes:[]},this._cur={...rs.idle},this._rgb=cs(this._config?.idle_color??"#3db4c8"),this._observe()}this._ctx&&(this._measure(),this._pump())}_observe(){typeof ResizeObserver<"u"&&(this._ro?.disconnect(),this._ro=new ResizeObserver(()=>this._measure()),this._ro.observe(this._canvas)),typeof IntersectionObserver<"u"?(this._io?.disconnect(),this._io=new IntersectionObserver(t=>{this._onScreen=t.some(e=>e.isIntersecting),this._pump()}),this._io.observe(this._canvas)):this._onScreen=!0}_measure(){let t=this._canvas;if(!t||!this._ctx)return;let e=t.clientWidth||Number(this._config?.size)||240,s=t.clientHeight||e,i=(this._perf?.q??1)<.75?1:2,n=st(window.devicePixelRatio||1,1,i);this._w===e&&this._h===s&&this._dpr===n&&this._particles||(this._w=e,this._h=s,this._dpr=n,t.width=Math.round(e*n),t.height=Math.round(s*n),this._ctx.setTransform(n,0,0,n,0,0),this._buildField())}_buildField(){let t=Number(this._config?.particles)||0,e=st(Math.round((this._w||240)*32),9e3,2e4),s=t>0?st(t,0,8e3):e,i=Math.max(400,Math.round(s*(this._perf?.q??1))),n=_e(24301),o=new Array(i),a=0,r=Math.round(i*qt[0].share);for(let c=0;c<i;c++){r--<=0&&a<qt.length-1&&(a++,r=Math.round(i*qt[a].share));let d=(n()+n()-1)*(n()<.04?4:1),p=(n()+n()-1)*1.05;o[c]={ri:a,lon:n()*Math.PI*2,sinLat:Math.sin(p),cosLat:Math.cos(p),off:d,drift:(n()-.5)*.13,tw:.5+n()*2,ph:n()*Math.PI*2,bobA:.1+n()*.25,bobW:.25+n()*.85,bobP:n()*Math.PI*2,wobA:.006+n()*.02,wobW:.4+n()*1.2,wobP:n()*Math.PI*2,lf:5+n()*7,lt:n()*12,sz:n()<.03?2.1+n()*1.1:.8+n()*.85,halo:n()<.05,br:n()<.04?1:.45+n()*.55}}this._particles=o}_audioSync(t){if(!t||t.state!=="playing"){this._env=null,this._envUrl=null;return}let e=t.attributes||{},s=String(e.media_content_id||""),i=/^https?:\/\//.test(s)||s.startsWith("/")?s:null,n=Date.parse(e.media_position_updated_at||t.last_changed||"");this._envAt=Number.isFinite(n)?n:Date.now(),this._envPos=Number(e.media_position)||0,!(!i||i===this._envUrl)&&(this._envUrl=i,this._env=null,i&&!(Number(e.media_duration)>60)&&this._decodeAudio(i))}async _pipelineId(t){if(this._pipeId!==void 0)return this._pipeId;this._pipeId=null;let e=await t.connection.sendMessagePromise({type:"assist_pipeline/pipeline/list"}),s=await t.connection.sendMessagePromise({type:"assist_pipeline/device/list"}),i=t.entities?.[this._config.entity]?.device_id,n=s?.find(c=>c.device_id===i)?.pipeline_entity,o=n?t.states?.[n]?.state:null,a=e?.pipelines||[],r=a.find(c=>c.name===o)||a.find(c=>c.id===e?.preferred_pipeline);return this._pipeId=r?.id||null,this._pipeId}async _grabTtsUrl(){let t=this._hass;if(!(!t?.connection||this._grabbing)){this._grabbing=!0;try{let e=await this._pipelineId(t);if(!e)return;for(let s=0;s<3;s++){let n=((await t.connection.sendMessagePromise({type:"assist_pipeline/pipeline_debug/list",pipeline_id:e}))?.pipeline_runs||[]).reduce((o,a)=>!o||a.timestamp>o.timestamp?a:o,null);if(n&&Date.now()-Date.parse(n.timestamp)<6e4){let a=(await t.connection.sendMessagePromise({type:"assist_pipeline/pipeline_debug/get",pipeline_id:e,pipeline_run_id:n.pipeline_run_id}))?.events||[];for(let r=a.length-1;r>=0;r--){let c=a[r]?.type==="tts-end"&&a[r]?.data?.tts_output?.url;if(c){this._envUrl=c,this._env=null,await this._decodeAudio(c);return}}}await new Promise(o=>setTimeout(o,250))}}catch{this._pipeId=void 0}finally{this._grabbing=!1}}}async _decodeAudio(t){try{let e=await(await fetch(t)).arrayBuffer(),s=window.AudioContext||window.webkitAudioContext;if(!s)return;let n=await(this._actx||(this._actx=new s)).decodeAudioData(e);if(t!==this._envUrl)return;this._env=ts(n.getChannelData(0),n.sampleRate,ds)}catch{this._env=null}}_audioLevel(){let t=this._env,e=this._envEl;if(e)return e.currentTime?t?os(t,e.currentTime):null:0;if(!t||this._mp!=="playing")return null;let s=this._envPos+(Date.now()-this._envAt)/1e3+(Number(this._config.audio_offset)||0);return os(t,s)}_sylShapes(t,e){let s=this._speech;s.pulses.push({born:s.t,amp:t}),s.pulses.length>6&&s.pulses.shift();let i=Math.random()*6.283185;s.spikes.push({a:i,sg:.1+Math.random()*.08,h:.06+t*.06,born:s.t,dur:.12+Math.random()*.08},{a:i+(Math.random()-.5)*.6,sg:.22+Math.random()*.18,h:.04+t*.05,born:s.t+.04,dur:e*(.9+Math.random()*.4)}),s.spikes.length>14&&s.spikes.splice(0,s.spikes.length-14)}_speechTick(t){let e=this._speech;e.t+=t;let s=this._audioLevel();if(s!=null){s>.2&&s>(e.last||0)*1.4&&(e.count++,e.syl={start:e.t,dur:.22,peak:s,f:5+s*4},this._sylShapes(s,.22)),e.last=s,e.live=!0;let a=s>e.env?.05:.14;e.env+=(s-e.env)*(1-Math.exp(-t/a)),e.env>1&&(e.env=1);return}if(e.live=!1,e.t>=e.next){let a=.22+Math.random()*.26,r=.5+Math.random()*.5;e.syl={start:e.t,dur:a,peak:r,f:5+Math.random()*4},e.count++;let c=.02+Math.random()*.05;e.count%(5+Math.floor(Math.random()*6))===0&&(c+=.14+Math.random()*.26),e.next=e.t+a+c,this._sylShapes(r,a)}let i=0,n=e.syl;if(n){let a=(e.t-n.start)/n.dur;a>=0&&a<=1&&(i=n.peak*1.2*(.5-.5*Math.cos(2*Math.PI*a)))}let o=i>e.env?.22:.5;e.env+=(i-e.env)*(1-Math.exp(-t/o)),e.env>1&&(e.env=1)}_pulseTable(t){let e=this._ptab||(this._ptab=new Float32Array(ht));if(e.fill(0),t<.01)return e;let s=this._speech;for(let i of s.pulses){let n=s.t-i.born;if(n>2.4)continue;let o=.58+n*.26,a=i.amp*Math.exp(-n/1)*t;for(let r=0;r<ht;r++){let c=ls+r/(ht-1)*hs-o;e[r]+=a*Math.exp(-(c*c)/.0055)}}return e}_peakTable(t,e,s){let i=this._ktab||(this._ktab=new Float32Array(ct));i.fill(0);let n=this._t,o=.05*e.amp+.08*s;for(let r of this._peaks){r.a+=t*r.w*(.6+e.swirl);let c=.35+.65*(.5+.5*Math.sin(n*r.f+r.ph)),d=r.h*c*o;if(d<.002)continue;let p=r.sg*(1-.4*s),u=2*p*p;for(let _=0;_<ct;_++){let b=_/ct*6.283185-r.a;b=(b%6.283185+6.283185)%6.283185,b>3.141593&&(b-=6.283185),i[_]+=d*Math.exp(-(b*b)/u)}}let a=this._speech;for(let r=a.spikes.length-1;r>=0;r--){let c=a.spikes[r],d=a.t-c.born;if(d>c.dur+.3){a.spikes.splice(r,1);continue}if(d<0)continue;let p=d<.12?d/.12:1,u=d>c.dur?Math.exp(-(d-c.dur)/.3):1,_=c.h*p*u*e.speech;if(_<.003)continue;let b=2*c.sg*c.sg;for(let m=0;m<ct;m++){let k=m/ct*6.283185-c.a;k=(k%6.283185+6.283185)%6.283185,k>3.141593&&(k-=6.283185),i[m]+=_*Math.exp(-(k*k)/b)}}return i}_sprite(t,e,s){let i=t<<16|e<<8|s;if(this._sprKey===i)return this._spr;let n=this._spr||(this._spr=document.createElement("canvas"));n.width=n.height=32;let o=n.getContext("2d");o.clearRect(0,0,32,32);let a=o.createRadialGradient(16,16,0,16,16,16);return a.addColorStop(0,`rgba(${t},${e},${s},0.75)`),a.addColorStop(.4,`rgba(${t},${e},${s},0.3)`),a.addColorStop(1,`rgba(${t},${e},${s},0)`),o.fillStyle=a,o.fillRect(0,0,32,32),this._sprKey=i,n}_segTick(t){if(this._segRot===void 0&&(this._segRot=-Math.PI/2),this._segRot+=t*.019,this._segWave=(this._segWave||0)+t*.5,this._sessions==null)return this._ambientTick(t);let e=this._segMap||(this._segMap=new Map),s=1-Math.exp(-t/.7),i=new Set;for(let n of this._sessions){i.add(n.id);let o=e.get(n.id);o||(o={size:.02,fill:Math.random(),pulse:Math.random()*6.28,rgb:[46,157,245],gone:!1},e.set(n.id,o)),o.weight=Math.max(.8,Math.log10((n.bytes||0)+1e4)-3.2),o.busy=!!n.busy,o.done=!!n.done,o.gone=!1}for(let[n,o]of e){if(i.has(n)||(o.gone=!0),o.size+=((o.gone?0:o.weight)-o.size)*s,o.gone&&o.size<.03){e.delete(n);continue}o.pulse+=t*(o.busy?2.4:.9),o.busy&&(o.fill=(o.fill+t*.3)%1);let a=o.done?[40,226,138]:[46,157,245];for(let r=0;r<3;r++)o.rgb[r]+=(a[r]-o.rgb[r])*s}}_segBand(t){let e=Math.abs(-Math.sin(t)-Math.sin(this._segWave||0));return e>1?0:.5+.5*Math.cos(e*Math.PI)}_wash(t,e,s,i,n,o,a,r){let c=Math.max(2,Math.min(12,Math.ceil((a-o)/.1))),d=(a-o)/c;for(let p=0;p<c;p++){let u=o+p*d,_=Math.min(a,u+d);t.globalAlpha=r*(.5+1.15*this._segBand(u+d/2)),t.beginPath(),t.arc(e,s,n,u,_),t.arc(e,s,i,_,u,!0),t.closePath(),t.fill()}}_drawSegs(t,e,s,i,n,o,a){if(this._sessions==null)return this._drawAmbientSegs(t,e,s,i,n,o,a);let r=6.283185,c=i*.475,d=i*.655,p=(m,k,L,M)=>{t.beginPath(),t.arc(e,s,M,m,k),t.arc(e,s,L,k,m,!0),t.closePath()},u=this._segMap,_=0;if(u)for(let m of u.values())_+=m.size;if(!u||!u.size||_<=0){t.fillStyle=`rgb(${n},${o},${a})`,t.globalAlpha=.05,p(0,r,c,d),t.fill(),t.globalAlpha=1;return}let b=this._segRot;for(let m of u.values()){let k=m.size/_*r,L=Math.min(.035,k),M=b+L/2,y=b+k-L/2;b+=k;let I=y-M;if(!(I<.004)&&(t.fillStyle=`rgb(${Math.round(m.rgb[0])},${Math.round(m.rgb[1])},${Math.round(m.rgb[2])})`,this._wash(t,e,s,c,d,M,y,(m.busy?.22:.1)+(m.done?.07:0)),m.busy)){let A=Math.max(.1,I*.35),T=M+m.fill*I,N=14;for(let z=0;z<N;z++){let w=T-z*A/N,it=Math.max(M,w-A/N);if(w<=M)break;t.globalAlpha=.3*Math.pow(1-z/N,1.6),p(it,w,c,d),t.fill()}}}t.globalAlpha=1}_ambientTick(t){let e=this._segs;if(!e){e=this._segs=[],this._segRot=-Math.PI/2;for(let n=0;n<22;n++){let o=Math.random()<.75;e.push({size:.5+Math.random()*1.4,fill:o?1:Math.random()*.7,rate:.12+Math.random()*.3,state:o?"done":"load",doneT:Math.random()*9})}}let s=0,i=0;for(let n of e)n.state==="grow"?s++:n.state==="die"&&i++;if(!s&&e.length<26&&Math.random()<t*.5&&e.splice(Math.floor(Math.random()*(e.length+1)),0,{size:.02,target:.5+Math.random()*1.4,fill:0,rate:.12+Math.random()*.3,state:"grow",doneT:0}),i<2&&e.length>16){let n=null;for(let o of e)o.state==="done"&&o.doneT>8&&(!n||o.doneT>n.doneT)&&(n=o);n&&Math.random()<t*.25&&(n.state="die")}for(let n=e.length-1;n>=0;n--){let o=e[n];o.state==="grow"?(o.size+=t*.5,o.size>=o.target&&(o.size=o.target,o.state="load")):o.state==="load"?(o.fill+=t*o.rate,o.fill>=1&&(o.fill=1,o.state="done",o.doneT=0)):o.state==="done"?o.doneT+=t:(o.size-=t*.12,o.fill=Math.max(0,o.fill-t*.25),o.size<=.02&&e.splice(n,1))}}_drawAmbientSegs(t,e,s,i,n,o,a){let r=this._segs;if(!r||!r.length)return;let c=0;for(let M of r)c+=M.size;if(c<=0)return;let d=i*.475,p=i*.655,u=n*.5+74|0,_=o*.72+48|0,b=a*.8+82|0;t.fillStyle=`rgb(${u},${_},${b})`;let m=(M,y,I,A)=>{t.beginPath(),t.arc(e,s,A,M,y),t.arc(e,s,I,y,M,!0),t.closePath()},k=6.283185,L=this._segRot;for(let M=0;M<r.length;M++){let y=r[M],I=y.size/c*k,A=Math.min(.028,I),T=L+A/2,N=L+I-A/2;L+=I;let z=N-T;if(!(z<.004)&&(this._wash(t,e,s,d,p,T,N,.13),y.fill>.01)){let w=y.state==="done"?.14+.2*Math.exp(-y.doneT/2.2):.34;this._wash(t,e,s,d,p,T,T+z*y.fill,w*.8)}}t.globalAlpha=1}_pump(){this._ctx&&this.isConnected&&this._onScreen!==!1&&!document.hidden?this._start():this._stop()}_start(){if(this._raf)return;this._last=performance.now();let t=e=>{this._raf=requestAnimationFrame(t);let s=e-this._last,i=Math.min(.05,s/1e3);this._last=e,this._perfTick(s),this._draw(i)};this._raf=requestAnimationFrame(t)}_perfTick(t){if(t<=0||t>250)return;let e=this._perf||(this._perf={q:1,acc:0,n:0,hold:40});if(e.hold>0){e.hold--;return}if(e.acc+=t,++e.n<45)return;let s=e.acc/e.n;e.acc=0,e.n=0,s>26&&e.q>.2?this._setQuality(Math.max(.2,e.q*.65)):s<14&&e.q<1&&this._setQuality(Math.min(1,e.q*1.2))}_setQuality(t){let e=this._perf;t!==e.q&&(e.q=t,e.hold=40,this._particles=null,this._measure())}_stop(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0}_targets(){let t=this._effectiveState(),e=t==="offline"?this._config.offline_color:this._config[as[t]];return{energy:rs[t],rgb:cs(e)}}_nearestAnchor(t,e,s){let i=s,n=s?Math.hypot(t.x-s.x,t.y-s.y)-s.r*.35:1/0;for(let o of e){let a=Math.hypot(t.x-o.x,t.y-o.y);a<n&&(n=a,i=o)}return i}_bubbleField(t){let e=t*.42;return{core:e,R:e,anchors:6,riders:16,minAnchor:t*.055,maxAnchor:t*.155,anchorR:()=>t*(.09+Math.random()*.055),riderR:()=>t*(.033+Math.pow(Math.random(),1.5)*.042)}}_spawnBubble(t,e,s,i,n,o){let a=n??Math.random()*Math.PI*2,r=i==="anchor",c=r?t.core*1.12:t.core*1.55;return{x:e+Math.cos(a)*c,y:s+Math.sin(a)*c,vx:0,vy:0,r:0,full:o??(r?t.anchorR():t.riderR()),anchor:r,host:null,held:!0,pop:-1,life:0,roll:Math.random()<.5?-1:1,wob:Math.random()*Math.PI*2}}_drawBubbles(t){let e=this._ctx,s=this._w,i=this._h;if(!s||!i)return;let n=s/2,o=i/2,a=Math.min(s,i)/2,{energy:r,rgb:c}=this._targets(),d=1-Math.exp(-t/.55),p=1-Math.exp(-t/.16),u=this._cur;for(let h of Object.keys(r)){let g=h==="speech"&&r[h]<u[h]?p:d;u[h]+=(r[h]-u[h])*g}for(let h=0;h<3;h++)this._rgb[h]+=(c[h]-this._rgb[h])*d;let _=Math.round(this._rgb[0]),b=Math.round(this._rgb[1]),m=Math.round(this._rgb[2]);r.speech>.5&&this._speech.env<.05&&(this._speech.next=this._speech.t,this._speech.pulses.length=0),u.speech>.005?this._speechTick(t):this._speech.env+=(0-this._speech.env)*d;let k=this._speech,L=.5+.5*Math.sin(k.t*.5+.8*Math.sin(k.t*.21)),M=k.live?.88:.62,y=(M*k.env+(1-M)*L)*u.speech;this._t+=t;let I=u.swirl/1.8,A=Number(this._config.particle_size)||1,T=this._bubbleField(a),N=Math.max(3,Math.round(T.anchors*A)),z=Math.max(4,Math.round(T.riders*A));if(this._bub&&this._bubHalf&&this._bubHalf!==a){let h=a/this._bubHalf;for(let g of this._bub)g.x=n+(g.x-n)*h,g.y=o+(g.y-o)*h,g.r*=h,g.full*=h,g.vx*=h,g.vy*=h,g.popR&&(g.popR*=h);this._bubHalf=a}if(!this._bub){this._bubHalf=a,this._bub=[];for(let h=0;h<N;h++){let g=this._spawnBubble(T,n,o,"anchor",h/N*Math.PI*2);g.r=g.full,this._bub.push(g)}for(let h=0;h<z;h++){let g=this._spawnBubble(T,n,o,"rider");g.r=g.full,this._bub.push(g)}this._release=0}let w=this._bub,it=w.filter(h=>h.anchor&&h.held&&h.pop<0),O=T.core*(1+y*.09+Math.sin(this._t*.7)*.012);for(this._release+=y*t*3.2;this._release>=1;){this._release-=1;let h=w.filter(H=>H.held&&!H.anchor&&H.pop<0&&H.r>H.full*.6),g=h.length>2?h:w.filter(H=>H.held&&H.pop<0&&H.r>H.full*.6);if(g.length<3)break;let $=g[Math.floor(Math.random()*g.length)];$.host=null,$.held=!1,$.life=0;let E=Math.hypot($.x-n,$.y-o)||1,j=($.x-n)/E,C=($.y-o)/E,U=a*(.5+Math.random()*.5);$.vx=j*U-C*a*.12,$.vy=C*U+j*a*.12}let pt=a*(.16+I*.32);for(let h of w){if(h.wob+=t*1.3,h.pop>=0){h.pop+=t;continue}if(h.held){if(h.r+=(h.full-h.r)*(1-Math.exp(-t/.45)),h.anchor){let $=Math.hypot(h.x-n,h.y-o)||1,E=(h.x-n)/$,j=(h.y-o)/$,U=(O+h.r-$)*8;h.vx+=(E*U-j*pt)*t,h.vy+=(j*U+E*pt)*t}else{!h.host||!h.host.held||h.host.pop>=0?h.host=this._nearestAnchor(h,it,null):h.host=this._nearestAnchor(h,it,h.host);let $=h.host;if($){let E=h.x-$.x,j=h.y-$.y,C=Math.hypot(E,j);C<.001&&(E=.1,j=0,C=.1);let U=E/C,H=j/C,Tt=($.r+h.r-C)*9,at=a*.22*h.roll;h.vx+=(U*Tt-H*at)*t,h.vy+=(H*Tt+U*at)*t}else{let E=Math.hypot(h.x-n,h.y-o)||1;h.vx+=(h.x-n)/E*(T.R-E)*5*t,h.vy+=(h.y-o)/E*(T.R-E)*5*t}}let g=Math.exp(-t*(h.anchor?3.4:4.6));h.vx*=g,h.vy*=g}else h.life+=t,h.vy-=a*.16*t,h.vx*=Math.exp(-t*.5),h.vy*=Math.exp(-t*.5),h.r*=Math.exp(-t*.22),(h.life>1.5+Math.random()*.6||h.x<-a||h.x>s+a||h.y<-a)&&(h.pop=0,h.popR=h.r);h.x+=h.vx*t,h.y+=h.vy*t}es(w,2),ss(w,n,o,O),is(w,n,o,O);for(let h=w.length-1;h>=0;h--)w[h].pop>.34&&w.splice(h,1);let At=h=>w.filter(g=>g.held&&g.pop<0&&g.anchor===h).length;for(;At(!0)<N;){let h=w.filter(C=>C.anchor&&C.held&&C.pop<0),{angle:g,gap:$}=ns(h,n,o),E=Math.sin(Math.min($,Math.PI)/2)*T.core*.85,j=Math.max(T.minAnchor,Math.min(T.maxAnchor,E));w.push(this._spawnBubble(T,n,o,"anchor",g,j))}for(;At(!1)<z;)w.push(this._spawnBubble(T,n,o,"rider"));e.clearRect(0,0,s,i),e.globalCompositeOperation="lighter";let nt=e.createRadialGradient(n-O*.3,o-O*.35,O*.08,n,o,O),ot=.34+y*.22;nt.addColorStop(0,`rgba(${Math.min(255,_+80)},${Math.min(255,b+80)},${Math.min(255,m+65)},${ot})`),nt.addColorStop(.6,`rgba(${_},${b},${m},${ot*.55})`),nt.addColorStop(1,`rgba(${_},${b},${m},0)`),e.fillStyle=nt,e.beginPath(),e.arc(n,o,O,0,Math.PI*2),e.fill(),e.strokeStyle=`rgba(${_},${b},${m},${.3+y*.28})`,e.lineWidth=Math.max(.8,O*.018),e.beginPath(),e.arc(n,o,O*.985,0,Math.PI*2),e.stroke(),e.fillStyle=`rgba(255,255,255,${.13+y*.12})`,e.beginPath(),e.arc(n-O*.36,o-O*.4,O*.14,0,Math.PI*2),e.fill();let Et=w.slice().sort((h,g)=>g.r-h.r);for(let h of Et){if(h.pop>=0){let C=h.pop/.34,U=(h.popR||h.r)*(1+C*1.5);e.strokeStyle=`rgba(${_},${b},${m},${(1-C)*.55})`,e.lineWidth=Math.max(.7,(h.popR||h.r)*.16*(1-C)),e.beginPath(),e.arc(h.x,h.y,U,0,Math.PI*2),e.stroke();continue}let g=h.r*(1+Math.sin(h.wob)*.02);if(g<.6)continue;let $=h.held?1:Math.max(0,1-h.life/2.1),E=(.5+y*.28)*$,j=e.createRadialGradient(h.x-g*.3,h.y-g*.35,g*.1,h.x,h.y,g);j.addColorStop(0,`rgba(${Math.min(255,_+95)},${Math.min(255,b+95)},${Math.min(255,m+75)},${E})`),j.addColorStop(.55,`rgba(${_},${b},${m},${E*.7})`),j.addColorStop(1,`rgba(${_},${b},${m},0)`),e.fillStyle=j,e.beginPath(),e.arc(h.x,h.y,g,0,Math.PI*2),e.fill(),e.strokeStyle=`rgba(${_},${b},${m},${(.26+y*.16)*$})`,e.lineWidth=Math.max(.5,g*.045),e.beginPath(),e.arc(h.x,h.y,g*.97,0,Math.PI*2),e.stroke(),g>3&&(e.fillStyle=`rgba(255,255,255,${(.26+y*.2)*$})`,e.beginPath(),e.arc(h.x-g*.34,h.y-g*.38,g*.17,0,Math.PI*2),e.fill())}e.globalCompositeOperation="source-over"}_draw(t){let e=this._ctx;if(!e)return;if(this._config.animation!=="jarvis-v1")return this._drawBubbles(t);if(!this._particles)return;let s=this._w,i=this._h,n=s/2,o=i/2,a=Math.min(s,i)/2,{energy:r,rgb:c}=this._targets(),d=1-Math.exp(-t/.55),p=1-Math.exp(-t/.16),u=this._cur;for(let f of Object.keys(r)){let S=f==="speech"&&r[f]<u[f]?p:d;u[f]+=(r[f]-u[f])*S}for(let f=0;f<3;f++)this._rgb[f]+=(c[f]-this._rgb[f])*d;let _=Math.round(this._rgb[0]),b=Math.round(this._rgb[1]),m=Math.round(this._rgb[2]);this._t+=t,this._waveT+=t*(.5+u.swirl*.9),this._spin+=t*(.09+u.swirl*.05),this._head+=t*(1.1+u.swirl*1.4),r.speech>.5&&this._cur.speech<.05&&(this._speech.next=this._speech.t,this._speech.pulses.length=0),u.speech>.005?this._speechTick(t):this._speech.env+=(0-this._speech.env)*d;let k=this._speech,L=.5+.5*Math.sin(k.t*.5+.8*Math.sin(k.t*.21)),M=k.live?.88:.62,y=(M*k.env+(1-M)*L)*u.speech,I=this._speech.syl?this._speech.syl.f:11;this._churnT+=t*(.55+u.swirl*.85+y*.7),this._waveT+=t*y*.8;let A=this._churnT,T=this._pulseTable(u.speech),N=this._peakTable(t,u,y);e.clearRect(0,0,s,i);let z=this._t,w=this._waveT,it=this._spin*.6,O=.955,pt=.296,At=.72+.28*Math.sin(z*.21+1.3)*Math.sin(z*.093+4.1),nt=.012*Math.sin(z*.16+.7),ot=a*.38*1.16,Et=a*.38*.7,h=ot*ot,g=ot-Et,$=.92,E=.075;e.fillStyle=`rgb(${_},${b},${m})`;let j=this._sprite(_,b,m),C=this._bins||(this._bins=[]);for(let f=0;f<Mt;f++)C[f]=new Path2D;let U=this._perf?.q??1,H=1+(1-U)*.6,ge=U>=.5,Tt=(Number(this._config.particle_size)||1)*st(a/220,.75,1.8)*(1+(1-U)*.35);for(let f of this._particles){let S=qt[f.ri],P=f.lon+it*S.rev+f.drift*A+f.wobA*(1+y*1)*(Math.sin(A*f.wobW+f.wobP)+.6*Math.sin(A*f.wobW*2.3+f.wobP*2.1)),q=Math.cos(P),J=Math.sin(P),Kt=f.cosLat*q,B=f.sinLat,Ct=f.cosLat*J,us=.45*Math.sin(5*P-w*1.4+B*2.3)+.3*Math.sin(8*P+w*1.05-B*3.1)+.3*Math.sin((Kt*.9+B*.32+Ct*.28)*3.1+w*.9)+.2*Math.sin(13*P-w*2.1+B*1.8),fs=.45*Math.cos(5*P-w*1.4+B*2.3)+.3*Math.cos(8*P+w*1.05-B*3.1),we=.5+.5*Math.sin(P-A*(.5+f.ri*.13)+f.ri*2.1),K=At*(.45+1.3*we*we)*(u.turb+y*.6);K>1.1&&(K=1.1);let _s=Math.sin((Kt*.7-B*.6+Ct*.4)*7.3+w*1.8),Pt=us*(.4+K)+_s*.38*K,$e=f.off+f.bobA*(.7+.6*K)*(Math.sin(A*f.bobW+f.bobP)+.55*Math.sin(A*f.bobW*2.7+f.bobP*1.9)),Qt=1-Math.min(1,Math.abs($e)),ke=u.amp*(1+y*.4),V=S.r+u.radius+nt+y*.015+S.amp*ke*Pt+$e*S.thick;Pt>.75&&(V+=(Pt-.75)*.04*K);let ut=Kt,ft=B*O-Ct*pt,gs=B*pt+Ct*O,jt=Math.sqrt(ut*ut+ft*ft)||1e-4,Me=Math.atan2(ft,ut),Gt=Me*.15915494%1;Gt<0&&(Gt+=1);let Xt=N[Gt*ct|0];V+=Xt*(.35+.65*Qt);let zt=(z+f.lt)%f.lf;zt/=f.lf,V+=(zt-.5)*.008;let Jt=6*zt*(1-zt);Jt>1&&(Jt=1);let bs=.24+.76*Qt*Qt,Q=f.br*S.glow*bs*Jt*(.55+.45*Math.abs(Math.sin(z*f.tw*.6+f.ph)))*u.bright;Q*=.68+.32*Math.sin(P*2.7+A*.45+f.ph*3);let Yt=jt*jt;if(Q*=.09+1.6*Yt*Yt*Yt,Q*=.62+.5*Math.max(0,Pt),Q*=.85+.3*K,Q*=1+Xt*(4+y*6),u.sweep>.01){let R=(Me-this._head)%6.283185;R<0&&(R+=6.283185),R>3.141593&&(R-=6.283185),Q*=1+Math.exp(-(R*R)/.25)*u.sweep*2.4}let Rt=0;if(u.speech>.01){let R=(V-ls)/hs*(ht-1);R=R<0?0:R>ht-1?ht-1:R|0,Rt=T[R],V+=Rt*.07,Q*=1+Rt*1.1+y*.7}V>$&&(V=$+E*Math.tanh((V-$)/E));let Se=V*a,Ae=gs*.5+.5,Ee=f.sz*Tt*(.78+.32*Ae)*(1+y*.25+Rt*.5+Xt*(.8+y*2)),Te=a*S.amp*ke*fs*(.5+K*.45),Ot=Se*ut-ft/jt*Te,It=Se*ft+ut/jt*Te,_t=1,Ce=Ot*Ot+It*It;if(Ce<h){if(_t=(Math.sqrt(Ce)-Et)/g,_t<.02)continue;_t*=_t}let Pe=st(Q*H*(.45+.65*Ae)*_t,0,1);if(f.halo&&ge){let R=Ee*8;e.globalAlpha=Pe*.22,e.drawImage(j,n+Ot-R/2,o+It-R/2,R,R)}let je=Ee*.56,ze=n+Ot,Re=o+It,Oe=C[Math.min(Mt-1,Pe*Mt|0)];Oe.moveTo(ze+je,Re),Oe.arc(ze,Re,je,0,6.283185)}for(let f=0;f<Mt;f++)e.globalAlpha=(f+.5)/Mt,e.fill(C[f]);e.globalAlpha=1,this._segTick(t),this._drawSegs(e,n,o,a,_,b,m);let at=a*.38,be=Math.cos(this._spin),me=Math.sin(this._spin),ve=Math.cos(.35),xe=Math.sin(.35),ye=fe.verts,Vt=ye.length;(!this._proj||this._proj.length!==Vt*3)&&(this._proj=new Float64Array(Vt*3));let D=this._proj;for(let f=0;f<Vt;f++){let S=ye[f],P=S[0]*be+S[2]*me,q=-S[0]*me+S[2]*be,J=S[1]*ve-q*xe;D[f*3]=n+P*at,D[f*3+1]=o-J*at,D[f*3+2]=S[1]*xe+q*ve}e.save(),e.beginPath(),e.arc(n,o,at,0,Math.PI*2),e.clip();let Wt=fe.edges,Ft=st(u.bright*(1+y*.45),.3,1.9);for(let f=0;f<2;f++){let S=f===1;e.beginPath();for(let P=0;P<Wt.length;P+=2){let q=Wt[P]*3,J=Wt[P+1]*3;D[q+2]+D[J+2]>0===S&&(e.moveTo(D[q],D[q+1]),e.lineTo(D[J],D[J+1]))}e.strokeStyle=S?`rgba(220,246,255,${.4*Ft})`:`rgba(${_},${b},${m},${.13*Ft})`,e.lineWidth=Math.max(.35,a*(S?.0032:.0024)),e.stroke()}e.fillStyle="rgba(235,252,255,1)";for(let f of Ns){let S=f.v*3;if(D[S+2]<=.15)continue;let P=Math.pow(Math.abs(Math.sin(z*f.tw+f.ph)),6)*Ft;if(P<.04)continue;e.globalAlpha=st(P,0,1);let q=Math.max(1,a*.008);e.fillRect(D[S]-q/2,D[S+1]-q/2,q,q)}e.globalAlpha=1,e.restore()}_fmtElapsed(t){if(t==null)return"";let e=Math.floor(t/60);return e<1?`${Math.floor(t)}s`:e<60?`${e}m`:`${Math.floor(e/60)}h ${e%60}m`}_chipProjects(){let t=n=>n.replace(/\b\w/g,o=>o.toUpperCase()),e=n=>typeof n=="string"?{project:n,label:t(n)}:n,s=this._config.build_projects,i=this._projects||[];return Array.isArray(s)&&s.length?s.map(e).filter(n=>!i.length||i.includes(n.project)):i.map(e)}_renderList(){let t=this._sessions;return x`
      <div class="phead">
        <button
          class="hbtn hex"
    ...
    `}render(){if(!this._config)return v;if(!this._hass?.states?.[this._config.entity])return x`
      ...
      `;let e=this._effectiveState(),s=e==="offline"?this._config.offline_color:this._config[as[e]],i=!!this._build,n=this._announce??null,o=this._messages??null;return x`
      <ha-card
        class="bg-${this._config.background}${this._config.honeycomb===!1?"":" comb"}${e==="offline"?" dim":""}"
        style=${this._config.honeycomb===!1?"":`--jr-comb:${Ds(s)}`}
      >
        <div
  ...
  `);var Bs=[{name:"entity",required:!0,selector:{entity:{domain:Dt}}},{name:"animation",selector:{select:{mode:"dropdown",options:[{value:"hubbubb",label:"Hubbubb - ring and bubbles"},{value:"jarvis-v1",label:"Jarvis v1 - segments and motes"}]}}},{name:"assistant_name",selector:{text:{}}},{name:"size",selector:{number:{min:80,max:600,step:10,mode:"slider"}}},{name:"background",selector:{select:{mode:"dropdown",options:[{value:"dark",label:"Deep space (dark)"},{value:"card",label:"Normal card background"},{value:"transparent",label:"Transparent"}]}}},{name:"honeycomb",selector:{boolean:{}}},{name:"tap_message",selector:{text:{}}},{name:"",type:"expandable",title:"Toggles",icon:"mdi:toggle-switch-outline",schema:[{name:"build_entity",selector:{entity:{domain:["switch","input_boolean"]}}},{name:"announce_entity",selector:{entity:{domain:["switch","input_boolean"]}}},{name:"messages_entity",selector:{entity:{domain:["switch","input_boolean"]}}}]},{name:"",type:"expandable",title:"Build panel",icon:"mdi:hexagon-multiple-outline",schema:[{name:"panel_fullscreen",selector:{boolean:{}}},{name:"panel_height",selector:{number:{min:0,max:1400,step:20,mode:"box"}}},{name:"build_dashboard",selector:{text:{}}},{name:"build_page",selector:{boolean:{}}},{name:"build_return",selector:{text:{}}}]},{name:"",type:"expandable",title:"Ring colours",icon:"mdi:palette",schema:[{name:"idle_color",selector:{text:{}}},{name:"listening_color",selector:{text:{}}},{name:"processing_color",selector:{text:{}}},{name:"responding_color",selector:{text:{}}},{name:"offline_color",selector:{text:{}}}]},{name:"",type:"expandable",title:"Panel colours",icon:"mdi:console",schema:[{name:"panel_bg",selector:{text:{}}},{name:"panel_border",selector:{text:{}}},{name:"panel_text",selector:{text:{}}},{name:"terminal_bg",selector:{text:{}}},{name:"terminal_text",selector:{text:{}}}]},{name:"",type:"expandable",title:"Advanced",icon:"mdi:tune",schema:[{name:"follow_media_player",selector:{boolean:{}}},{name:"audio_offset",selector:{number:{min:-2,max:2,step:.05,mode:"box"}}},{name:"media_player",selector:{entity:{domain:"media_player"}}},{name:"particle_size",selector:{number:{min:.3,max:3,step:.1,mode:"slider"}}},{name:"particles",selector:{number:{min:0,max:4e3,step:20,mode:"box"}}}]}],Vs={entity:"Assist satellite",animation:"Animation",assistant_name:"Assistant name",size:"Ring size (px)",background:"Card background",honeycomb:"Honeycomb background",follow_media_player:"Animate while the device is playing audio",audio_offset:"Audio sync offset (seconds)",media_player:"Speaker entity (blank = same device)",tap_message:"Spoken reply when the ring is tapped",particles:"Particle count, Jarvis v1 (0 = auto)",particle_size:"How many bubbles (1 = about 22)",build_entity:"Build mode toggle",announce_entity:"Agent announcement toggle",messages_entity:"Hubbubb message toggle",panel_fullscreen:"Full screen (floats over the dashboard)",panel_height:"Panel height in px (0 = match the ring)",build_dashboard:"Open this dashboard instead",build_page:"This card IS the build dashboard",build_return:"Exit goes back to",idle_color:"Idle",listening_color:"Listening",processing_color:"Processing",responding_color:"Responding",offline_color:"Unavailable",panel_bg:"Panel background",panel_border:"Panel border",panel_text:"Panel text",terminal_bg:"Terminal background",terminal_text:"Terminal text"},Bt=class extends F{setConfig(t){this._config={...de,...t}}render(){return this._config?x`
      ...
      ></ha-form>
    `:v}_valueChanged(t){t.stopPropagation();let e={...t.detail.value};for(let[s,i]of Object.entries(de))e[s]===i&&delete e[s];delete e.name,delete e.show_state,pe(this,"config-changed",{config:e})}};Ht(Bt,"properties",{hass:{},_config:{state:!0}});customElements.define("hubbubb-ring-card",St);customElements.define("hubbubb-ring-card-editor",Bt);window.customCards=window.customCards||[];window.customCards.push({type:"hubbubb-ring-card",name:"Hubbubb Ring",description:"Animated glowing ring that reacts to an Assist satellite's state.",preview:!0});console.info(`%c HUBBUBB-RING-CARD %c v${zs} `,"color:#0b1620;background:#35e0ff;font-weight:700","color:#35e0ff;background:#0b1620");
