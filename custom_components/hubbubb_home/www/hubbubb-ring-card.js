    ...
    `}_renderSession(){let t=(this._sessions||[]).find(e=>e.id===this._sel);return b`
      ...
      >
        ...
        ${(this._queue||[]).filter(e=>e.id===this._sel).map(e=>b`<div class="qitem ${e.state}">
              ...
              <div class="qbar">
                <span class="qtag">
                  ${e.state==="sent"?e.delivered?"sent \u2713":"sending\u2026":t!=null&&t.busy?"queued \xB7 sends when this turn ends":"queued"}
                </span>
                ${e.state==="held"?b`
